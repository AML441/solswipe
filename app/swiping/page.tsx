...
export default function SwipingPage() {
  ...
  const [noMoreOrgs, setNoMoreOrgs] = useState(false);
  // ----------------------
  // State
  // ----------------------
...
useEffect(() => {
  setNoMoreOrgs(!items || items.length === 0 || !items[currentIndex]);
}, [items, currentIndex]);
  ...
  return (
    <div className="min-h-screen bg-linear-to-b from-indigo-900 to-slate-900 flex flex-row">
      ...
      <div className="flex-1 flex flex-col items-center p-6">
        ...
        <div className="flex-1 flex flex-col h-full items-center justify-center gap-6 w-full">
          ...
          <div className="flex gap-6 mt-2">
            ...
            <button
              ...
              className={`px-4 py-2 rounded cursor-pointer ${!embeddingsReady ? 'bg-gray-500 text-gray-300' : 'bg-cyan-200 text-slate-900 hover:bg-teal-600'
                }`}
            >
              Interested
            </button>
